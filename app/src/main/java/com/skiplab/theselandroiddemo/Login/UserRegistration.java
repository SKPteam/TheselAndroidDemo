package com.skiplab.theselandroiddemo.Login;
...
public class UserRegistration extends AppCompatActivity {
    ...
    private TextInputEditText mUsername, mEmail, mPassword, mConfirmPwd, mAge;
    ...
    private DatabaseReference usersDb, userAccSettingsDb;
    ...
    private String username, email, phone, password, confirmPwd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userAccSettingsDb = firebaseDatabase.getReference("user_account_settings");
    ...
    private void registerUser(final String username, String email, String phone, String password) {
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull final Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful())
                        {
                            ...
                            userAccountSettings.setBio("Edit this bio from the account settings...");
                            userAccountSettings.setDate_created("");
                            userAccountSettings.setIsStaff("false");
                            userAccountSettings.setSelectedCategory("");
                            userAccountSettings.setDay_of_birth(dayOfMonthI);
                            userAccountSettings.setMonth_of_birth(birth_month);
                            userAccountSettings.setYear_of_birth(yearI);
                            userAccountSettings.setPosts(0);
                            userAccountSettings.setDate_created(timestamp);
                            userAccountSettings.setOnlineStatus(false);
                            userAccountSettings.setEverify(false);
                            userAccountSettings.setDisabled(false);
                            userAccountSettings.setAnonymous(false);

                            usersDb.child(mAuth.getCurrentUser().getUid())
                                    .setValue(user)
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if (task.isSuccessful()){
                                                ...
                                                userAccSettingsDb.child(mAuth.getCurrentUser().getUid())
